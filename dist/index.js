...
app.post("/api/transcribe", upload.single("file"), async (req, res) => {
    ...
    if (MOCK)
        return res.json({ transcript: "MOCK transcript: hello creators." });
